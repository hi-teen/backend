...
import backend.hiteen.auth.security.CustomUserService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private boolean isPermitPath(String path) {
        return path.equals("/") ||
                ...
                path.equals("/api/v1/members/sign-up") ||
                path.startsWith("/api/v1/school-meal") ||
                path.startsWith("/api/v1/timetable") ||
